...
<body>
	<div class="Personal">
		<div class="navigation">
		  <a href="Personal.html" class="personal_category">Личный кабинет</a>
		  <a href="Messages.html" class="messages_category">Мои сообщения</a>
		  <a href="Profile.html" class="profile_category">Мой профиль</a>
		</div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <ul class="footer_menu">
                        <li><a href="main.html">Главное</a></li>
                        <li><a href="main.html#mentors">Специалисты</a></li>
                        <li><a href="main.html#info">О компании</a></li>
                    </ul>
                </div>
            </div>
        </div>
