    ...
    <div class="main">
        <div class="main_content">
            <div class="main_content_title _anim-items _anim-no-hide">
                ...
                <h1>Быстро, удобно, <br> доступно.</h1>
            </div>
            <div class="main_content_text _anim-items _anim-no-hide">
                <p>Удобный интерфейс, различные категории курсов, все что нужно для знаний.</p>
            </div>
        </div>
    </div>
        ...
        <div class="advantages">
                ...
                <div class="container">
                    ...
                    <div class="container_content">
                        ...
                        <div class="container_content_text _anim-items _anim-no-hide">
                            <p>Платформа имеет любой формат обучением, который напрямую обговаривается с преподом.</p>
                        </div>
                    </div>
                </div>
                <div class="container">
                    ...
                    <div class="container_content">
                        ...
                        <div class="container_content_text _anim-items _anim-no-hide">
                            <p>Каждый ученик имеет возможность выбрать курс, записаться на него и узнать, что-то новое</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="column">
                <div class="container">
                    ...
                    <div class="container_content">
                        <div class="container_content_title _anim-items _anim-no-hide">
                            <h3>Как стать преподавателем?</h3>
                        </div>
                        <div class="container_content_text _anim-items _anim-no-hide">
                            <p>Любой желающий может разместить свой курс на нашем сайте.</p>
                        </div>
                    </div>
                </div>
                <div class="container">
    ...
    <div class="info">
        ...
        <div class="info_content">
            ...
            <div class="info_content_text _anim-items _anim-no-hide">
                <p>Одним из преимуществ нашего сайта является то,</p>
                <p>что каждый желающий может стать репетитором,</p>
                <p>притом неважен вид деятельности,</p>
                <p>будь то программирование или киберспорт.</p>
                <p>Любой желающий сможет выбрать для себя курс,</p>
                <p>а наш сайт поможет в этом.</p>
            </div>
        </div>
    </div>
